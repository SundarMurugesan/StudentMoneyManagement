	...
	//	walletDatasource.open();
		...
		OKButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				BigDecimal walletDecimal = new BigDecimal(initialWalletInput.getText().toString());
				BigDecimal budgetDecimal = new BigDecimal(initialBudgetInput.getText().toString());
